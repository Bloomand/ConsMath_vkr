...
const Estimation = ({ navigation }) => {
  ...
  return (
    <View style={styles.main}>
      ...
      <TouchableOpacity style={styles.start} onPress={() => navigation.navigate(isEndlessMode ? 'EndlessGameEst' : 'RankedGameEst', { dificult: selectedDifficulty, mode: isEndlessMode, type: selectedArif })}>
